program laplace_neumann
    ...
    integer, parameter :: lx=68, ly=68 ! BOUNDARIES at x,y =0 and x,y=33.
    ...
    A=-35.0d0; B=-20.0d0; C=10.0d0; D=-5.0d0
    ...
    do ! LOOP OVER ITERATIONS
       ...
       ! shift_temp = 4000.0d0 - temp(1,2) 
       ! shift_temp = 4000.0d0 - temp(2,1) 
       ! shift_temp = 4000.0d0 - temp(2,2) 
    ...
    open(10, file="testpdeq4_68output.dat" ,status='replace')
do ii=  1 ,ly 
        write(10,*)  temp(1:lx,ii)
    enddo
close(10)
write(*,*) "your file is ready "

write(*,*) temp(10,10) , temp(20,20)
