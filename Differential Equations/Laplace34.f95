...
open(12, file="old_tempq34.dat",status='replace') ! WRITE DOWN THE BOUNDARY CONDITIONS at ZEROTH ITERATION
do ii=1, lx
    do jj=1, ly
...
open(10, file="pdeq34_output.dat" ,status='replace')
do ii=lx, 1,-1
   
        write(10,*) temp(1:34,i)
    enddo
