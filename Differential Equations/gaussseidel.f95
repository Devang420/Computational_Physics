program name
    ...
    real*8 :: dx=0.0010d0, limit=0.000010d0,initialpt=0.0d0, finalpt=1.0d0 
    ...
    open(file='gaussinitial.dat',unit=2)
    do i=1,nop 
        write(2,*) x(i), y(i)
    end do
    k=0
    ...
    do
        ...
        y_ini=y 
        do i=2,nop-1
            y(i)=a*(b*y_ini(i+1)+c*y(i-1)-d*x(i))
        end do
        cond=1
        do i=2,nop-1
    ...
    open(file='gaussfinal.dat', unit=3)
    do i=1,nop
        write(3,*) x(i), y(i)
    end do
